...
class UserProfileUpdate(BaseModel):
    ...
    All fields are optional because the profile can be updated partially.
    """
    ...
    preferred_work_formats: list[WorkFormat] | None = None
    ...
    motivation_factors: list[MotivationFactor] | None = None
